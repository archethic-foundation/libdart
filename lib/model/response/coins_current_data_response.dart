...
CoinsCurrentDataResponse coinsCurrentDataResponseFromJson(String str) => CoinsCurrentDataResponse.fromJson(json.decode(str));

String coinsCurrentDataResponseToJson(CoinsCurrentDataResponse data) => json.encode(data.toJson());
...
class CoinsCurrentDataResponse {
    ...
    factory CoinsCurrentDataResponse.fromJson(Map<String, dynamic> json) => CoinsCurrentDataResponse(
        id: json["id"],
        symbol: json["symbol"],
        name: json["name"],
...
class Ticker {
    ...
    factory Ticker.fromJson(Map<String, dynamic> json) => Ticker(
        ...
        tokenInfoUrl: json["token_info_url"] == null ? null : json["token_info_url"],
        coinId: json["coin_id"],
        targetCoinId: json["target_coin_id"] == null ? null : json["target_coin_id"],
    );
