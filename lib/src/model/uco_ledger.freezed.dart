...
abstract class $UCOLedgerCopyWith<$Res> {
  factory $UCOLedgerCopyWith(UCOLedger value, $Res Function(UCOLedger) then) =
      _$UCOLedgerCopyWithImpl<$Res>;
  $Res call({List<UCOTransfer> transfers});
}

/// @nodoc
class _$UCOLedgerCopyWithImpl<$Res> implements $UCOLedgerCopyWith<$Res> {
  _$UCOLedgerCopyWithImpl(this._value, this._then);

  final UCOLedger _value;
  // ignore: unused_field
...
/// @nodoc
class __$$_UCOLedgerCopyWithImpl<$Res> extends _$UCOLedgerCopyWithImpl<$Res>
    implements _$$_UCOLedgerCopyWith<$Res> {
  __$$_UCOLedgerCopyWithImpl(
      _$_UCOLedger _value, $Res Function(_$_UCOLedger) _then)
      : super(_value, (v) => _then(v as _$_UCOLedger));

  @override
  _$_UCOLedger get _value => super._value as _$_UCOLedger;
